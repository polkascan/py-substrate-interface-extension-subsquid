...
setup(
    ...
    name='substrate-interface-subsquid',  # Required
    ...
    description='py-substrate-interface extension to utilize Subsquid indexes',  # Optional
    ...
    url='https://github.com/polkascan/py-substrate-interface-extension-subsquid',  # Optional
    ...
    keywords='substrate-interface extension subsquid',  # Optional
